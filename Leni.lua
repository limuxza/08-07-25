...
function Linux.Create(config)
    ...
    local Main = Linux.Instance("Frame", {
        ...
        BorderColor3 = Color3.fromRGB(200, 200, 210),
            ...
            local function UpdateToggle(thisToggle)
                ...
                if thisTrack and thisKnob then
                    ...
                    if currentState then
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(138, 43, 226)}):Play()
    ...
    task.spawn(function()
        ...
        if DefaultTab and Tabs[DefaultTab] then
            ...
            defaultTab.Button.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
            defaultTab.Button.BackgroundTransparency = 0.5
        ...
        elseif tabOrder > 0 then
            ...
            if firstTab then
                ...
                firstTab.Button.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
                firstTab.Button.BackgroundTransparency = 0.5
